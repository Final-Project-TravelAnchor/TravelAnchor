...
public class TravelPlanController {
    ...
    @Operation(summary = "여행 일정 수정 요청", description = "해당 여행일정 수정이 진행됩니다.", tags = { "TravelPlanController" })
    ...
    @Operation(summary = "여행 일정 삭제 요청", description = "해당 여행일정 삭제가 진행됩니다.", tags = { "TravelPlanController" })
