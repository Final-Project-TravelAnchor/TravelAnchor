...
INSERT INTO tbl_population (travel_code, member_code, country_code, population_title, population_description, population_created_at, population_views, population_people, population_onoff) VALUES
 (1, 1, 1, '서울 역사 투어', '서울의 유서 깊은 명소를 탐방하는 여행입니다.', '2024-01-01', 120, 5, 'Y'),
 (2, 2, 2, '부산 해변 여행', '부산의 아름다운 해변과 자연을 만끽하세요.', '2024-01-03', 90, 4, 'N'),
 (3, 3, 3, '제주도 힐링 여행', '제주도의 자연 속에서 힐링과 여유를 느껴보세요.', '2024-01-06', 210, 6, 'Y'),
 (4, 4, 4, '경주 문화 탐방', '경주의 전통과 문화를 체험하는 여행입니다.', '2024-01-08', 150, 3, 'N'),
 (5, 5, 5, '강릉 커피 투어', '강릉의 커피 문화와 명소를 탐방해 보세요.', '2024-01-10', 80, 2, 'Y'),
 (6, 6, 6, '인천 역사 유적지 탐방', '인천의 숨겨진 역사 유적지를 만나보세요.', '2024-01-12', 140, 4, 'N'),
 (7, 7, 7, '전주 한옥 마을 여행', '전주의 전통 한옥에서 특별한 추억을 만들어 보세요.', '2024-01-15', 250, 7, 'Y'),
 (8, 8, 8, '속초 바다 낚시 여행', '속초에서 낚시를 하며 힐링과 여유를 즐기세요.', '2024-01-18', 110, 5, 'N'),
 (9, 9, 9, '대구 음식 투어', '대구의 맛집을 탐방하며 다양한 음식을 즐기세요.', '2024-01-20', 300, 8, 'Y'),
 (10, 10, 10, '광주 미술관 투어', '광주의 다양한 미술관을 탐방하며 예술을 느껴보세요.', '2024-01-22', 170, 4, 'N'),
 (11, 11, 11, '울산 공업 도시 탐방', '울산의 공업 도시를 경험하며 산업 발전을 느껴보세요.', '2024-01-25', 200, 6, 'Y'),
 (12, 12, 12, '수원 화성 투어', '수원의 화성과 그 주변 명소를 탐방하는 여행입니다.', '2024-01-28', 180, 5, 'N'),
 (13, 13, 13, '포항 해양 탐험', '포항의 해양 명소와 자연을 즐기며 힐링하세요.', '2024-02-01', 90, 3, 'Y'),
 (14, 14, 14, '춘천 호수 투어', '춘천의 아름다운 호수를 탐방하는 여행입니다.', '2024-02-03', 100, 4, 'N'),
 (15, 15, 15, '남해 섬 여행', '남해의 아름다운 섬을 탐험하며 자연을 느껴보세요.', '2024-02-06', 120, 6, 'Y'),
 (16, 16, 16, '광양 매화 축제 투어', '광양의 매화 축제를 즐기며 봄을 만끽하세요.', '2024-02-10', 250, 7, 'N'),
 (17, 17, 17, '안동 하회마을 탐방', '안동의 전통 마을에서 한국의 역사를 느껴보세요.', '2024-02-15', 230, 5, 'Y'),
 (18, 18, 18, '여수 밤바다 여행', '여수의 밤바다와 낭만을 느낄 수 있는 여행입니다.', '2024-02-18', 270, 8, 'N'),
 (19, 19, 19, '김포 평화 관광', '김포의 평화 관광지에서 한반도의 역사를 배워보세요.', '2024-02-20', 130, 4, 'Y'),
 (20, 20, 20, '군산 역사 투어', '군산의 근대 역사와 문화를 탐방하는 여행입니다.', '2024-02-25', 160, 6, 'N');
...
(1, 1, 1, '홍길동', '일반 채팅방에 오신 것을 환영합니다!', '2024-01-05 10:00:00', 'CHAT'),
(2, 1, 3, '박영희', '안녕하세요! 다들 어떻게 지내세요?', '2024-01-05 10:05:00', 'CHAT'),
(3, 1, 2, '김철수', '다음 달에 일본 여행 가실 분 있나요?', '2024-02-16 09:30:00', 'CHAT'),
(4, 1, 1, '홍길동', '흥미롭네요! 저도 참여할 수 있을 것 같아요.', '2024-02-16 09:45:00', 'CHAT'),
(5, 1, 3, '박영희', '여러분이 가장 좋아하는 길거리 음식은 뭐예요?', '2024-03-10 12:15:00', 'CHAT'),
(6, 1, 4, '이민호', '저는 타코를 좋아해요! 특히 매운 타코요.', '2024-03-10 12:20:00', 'CHAT'),
(7, 1, 2, '김철수', '새로운 VR 헤드셋 사용해보신 분 있나요?', '2024-04-20 16:00:00', 'CHAT'),
(8, 1, 1, '홍길동', '풍경 사진 찍는 팁 좀 알려주세요.', '2024-05-01 14:45:00', 'CHAT'),
(9, 1, 5, '최수현', '다들 이번 주말에 뭐 하세요?', '2024-05-01 15:00:00', 'CHAT'),
(10, 2, 6, '이정훈', '이번 여행에서 가장 기대되는 순간은 뭐예요?', '2024-05-02 10:30:00', 'CHAT'),
(11, 2, 2, '김철수', '저는 유명한 관광지보다 숨겨진 명소를 찾는 걸 좋아해요.', '2024-05-02 11:00:00', 'CHAT'),
(12, 2, 1, '홍길동', '여행 중에 좋은 음식점 아시는 분 있나요?', '2024-05-02 11:30:00', 'CHAT'),
(13, 2, 4, '이민호', '이탈리아에서는 꼭 피자를 먹어봐야 해요!', '2024-05-02 12:00:00', 'CHAT'),
(14, 2, 3, '박영희', '다음에 여행 가면 같이 가고 싶어요!', '2024-05-02 13:15:00', 'CHAT'),
(15, 3, 5, '최수현', '오늘 날씨가 너무 좋아요. 산책 가실 분?', '2024-05-02 14:30:00', 'CHAT'),
(16, 3, 6, '이정훈', '저는 카페에서 책 읽는 걸 좋아해요.', '2024-05-02 15:00:00', 'CHAT'),
(17, 3, 2, '김철수', '어제 본 영화 정말 감동적이었어요.', '2024-05-02 16:00:00', 'CHAT'),
(18, 3, 1, '홍길동', '영화 제목이 뭐였어요?', '2024-05-02 16:15:00', 'CHAT'),
(19, 3, 3, '박영희', '다음 주에 콘서트 보러 갈 사람?', '2024-05-02 17:00:00', 'CHAT'),
(20, 3, 4, '이민호', '어떤 콘서트인가요? 관심 있어요.', '2024-05-02 17:15:00', 'CHAT');
